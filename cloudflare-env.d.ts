/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 36d0def149bb45a61b09216676110edc)
...
declare namespace Cloudflare {
	interface Env {
		...
		ASSETS: Fetcher;
		NEXT_PUBLIC_SITE_URL: "https://mailsocial.sudipbiswas.dev";
		DODOPAYMENTS_ENVIRONMENT: "live_mode";
		DODOPAYMENTS_PRODUCT_ID: "pdt_0Nbapc0wvVMapJ3yh53vq";
		NEXT_PUBLIC_RESEND_DOMAIN: "sudipbiswas.dev";
		WORKER_SELF_REFERENCE: Fetcher /* mailsocial */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SITE_URL" | "DODOPAYMENTS_ENVIRONMENT" | "DODOPAYMENTS_PRODUCT_ID" | "NEXT_PUBLIC_RESEND_DOMAIN">> {}
}
